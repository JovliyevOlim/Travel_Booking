...
function Home(props) {
  return (
    ...
    <>
          ...
          <Col lg="6">
            <div className="hero__content">
              ...
              <p>
                ...
                ipsam, molestiae voluptate mollitia nemo illo facere dolor?
                Soluta a tempora, rerum, officiis quis aperiam mollitia delectus
                quisquam labore repellat facere!
              </p>
            </div>
          </Col>
          <Col lg="2">
      ...
      <section>{/* hero section start */}</section>
      <section>
        <Container>
          <Row>
            <Col lg="3">
                  ...
                  <Col lg="6">
                    <div className="experience__content">
                      ...
                      <p>
                        ...
                        <br />
                          Tenetur quam deserunt commodi doloremque ex corporis.
                      </p>
                    </div>
